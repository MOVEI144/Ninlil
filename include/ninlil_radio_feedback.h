...
int ninlil_radio_feedback_open(ninlil_radio_feedback *owner, int8_t minimum_dbm,
                               int8_t maximum_dbm);
 ...
 */
int ninlil_radio_feedback_finish(ninlil_radio_feedback *owner,
                                 int driver_result, int8_t applied_power_dbm,
                                 uint64_t now_ms, uint64_t probe_token,
