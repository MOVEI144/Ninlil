...
static bool ninlil_decoder_encode_byte_string_type_bstr_type(zcbor_state_t *state, void *data)
{
    return encode_byte_string_type_bstr_type(state, data);
}
		...
		size_t *payload_len_out)
{
	...
	return zcbor_entry_function(payload, payload_len, (void *)input, payload_len_out, states,
		ninlil_decoder_encode_byte_string_type_bstr_type, sizeof(states) / sizeof(zcbor_state_t), 1);
}
