...
static bool ninlil_decoder_encode_plaintext_2(zcbor_state_t *state, void *data)
{
    return encode_plaintext_2(state, data);
}
...
static bool ninlil_encoder_zcbor_bstr_encode(zcbor_state_t *state, const void *data)
{
    return zcbor_bstr_encode(state, data);
}
		...
		zcbor_state_t *state, const struct EAD_2 *input)
{
	...
	bool tmp_result = (zcbor_multi_encode_minmax(1, 3, &(*input).EAD_2_count, ninlil_encoder_encode_ead_y, state, (&(*input).EAD_2), sizeof(struct ead_y)));
		...
		size_t *payload_len_out)
{
	...
	return zcbor_entry_function(payload, payload_len, (void *)input, payload_len_out, states,
		ninlil_decoder_encode_plaintext_2, sizeof(states) / sizeof(zcbor_state_t), 9);
}
