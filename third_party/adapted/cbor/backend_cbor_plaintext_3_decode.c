...
static bool ninlil_decoder_decode_plaintext_3(zcbor_state_t *state, void *data)
{
    return decode_plaintext_3(state, data);
}
		...
		zcbor_state_t *state, struct EAD_3 *result)
{
	...
	bool tmp_result = (zcbor_multi_decode(1, 3, &(*result).EAD_3_count, ninlil_decoder_decode_ead_y, state, (&(*result).EAD_3), sizeof(struct ead_y)));
		...
		size_t *payload_len_out)
{
	...
	return zcbor_entry_function(payload, payload_len, (void *)result, payload_len_out, states,
		ninlil_decoder_decode_plaintext_3, sizeof(states) / sizeof(zcbor_state_t), 8);
}
