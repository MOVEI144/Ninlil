...
static bool ninlil_decoder_decode_byte_string_type_bstr_type(zcbor_state_t *state, void *data)
{
    return decode_byte_string_type_bstr_type(state, data);
}
		...
		size_t *payload_len_out)
{
	...
	return zcbor_entry_function(payload, payload_len, (void *)result, payload_len_out, states,
		ninlil_decoder_decode_byte_string_type_bstr_type, sizeof(states) / sizeof(zcbor_state_t), 1);
}
